...
`
python3 collect_data.py --env prices --envs 10 --H 10 --dim 10 --var 0.3 --envs_eval 20 && \
python3 train.py --env prices --envs 10 --H 10 --dim 10 --var 0.3 --lr 0.0001 --layer 4 --head 4 --shuffle --num_epochs 100 --seed 1 && \
python3 eval.py --env prices --envs 10 --H 10 --dim 10 --var 0.3 --lr 0.0001 --layer 4 --head 4 --shuffle --epoch 100 --n_eval 20 --seed 1
`
