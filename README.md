...
`
python3 collect_data.py --env prices --envs 10000 --H 100 --dim 10 --var 0.01 --envs_eval 100 && \
python3 train.py --env prices --envs 10000 --H 100 --dim 10 --var 0.01 --lr 0.0001 --layer 4 --head 4 --shuffle --num_epochs 300 --seed 2 && \
python3 eval.py --env prices --envs 10000 --H 100  --dim 10 --var 0.01 --lr 0.0001 --layer 4 --head 4 --shuffle --epoch 300 --n_eval 100 --seed 2
`